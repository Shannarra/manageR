class User < ApplicationRecord
  ...
  def self.ransackable_attributes(auth_object = nil)
    %w[access_type created_at email encrypted_password gender id image name phone remember_created_at reset_password_sent_at reset_password_token updated_at]
  end
end
